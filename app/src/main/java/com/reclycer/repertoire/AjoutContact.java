...
public class AjoutContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prenom = (EditText) findViewById(R.id.edit_first_name);
        nom = (EditText) findViewById(R.id.edit_Name);
        numero = (EditText) findViewById(R.id.editNumero);
        previewpicture = (ImageView) findViewById(R.id.photo_preview);
        valider = (Button) findViewById(R.id.valider);
        takepic = (Button) findViewById(R.id.takepicbutton);
        importpic = (Button) findViewById(R.id.importbutton);
        photoFromApp = false;
